    ...
    <nav aria-label="breadcrumb" class="p-3 bg-custom-light">
        <div class="container">
            <ol class="breadcrumb m-0">
                ...
                <li class="breadcrumb-item active fs-sm" aria-current="page">Maya</li>
            </ol>
        </div>
    </nav>
            ...
            <div class="row align-items-start">
                <div class="col-8 d-flex">
                    <div class="col-3 d-flex flex-wrap row-gap-3">
                        <div class="col-12 rounded overflow-hidden">
                            <img src="img/maya.webp" alt="Maya" class="object-fit-cover w-100" height="120">
                        </div>
                    ...
                    <div class="col-9 rounded overflow-hidden">
                        <img src="img/maya.webp" alt="Maya" class="object-fit-cover w-100 ms-3" height="530">
                    </div>
                </div>
                ...
                <div class="py-3 col-4 d-flex flex-wrap row-gap-3">                   
                    ...
                    <div class="col-12">
                        ...
                        <div>Vila Joana, Jundiaí - SP</div>
                    </div>
                    
                    <div class="col-12">
                        <h3 class="fs-sm destaque m-0">Sobre</h3> 
                        <div>💖 Pequeninia e Peludinha </div>
                    </div>
